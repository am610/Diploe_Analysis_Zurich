...
file1 = pd.read_csv('FITOPT000_MUOPT000.FITRES', sep='\s+',comment='#')  # Contains CID, HOST_RA, HOST_DEC
file2 = pd.read_csv('hubble_diagram.txt', sep='\s+',comment='#')         # Contains CID and other columns
